...
步骤2. 添加依赖
	...
	dependencies {
          ...
          //1.1.0之后
		  implementation 'com.github.kellysong:DeviceConnector:1.2.0'
	}
...
8. 蓝牙搜索在Android 6.0以上需要申请定位权限；高版本蓝牙连接会弹出蓝牙配对授权窗口,建议在蓝牙设置里面进行配对和取消配对，配对一次即可或者直接通过蓝牙地址直连；如果基于Android 12+设备运行，需要开发者自行申请运行时的蓝牙扫描和连接权限
9. Wifi连接需要网络权限
